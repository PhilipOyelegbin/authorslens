          ...
          <figure key={index} className="w-full rounded-2xl shadow-lg shadow-slate-500 md:w-2/5">
            ...
            <figcaption className="p-5">
              ...
              <div className="flex items-center justify-end text-2xl gap-5 mt-3">
                <Link to={initiator.linkedin} target="_blank"><FaLinkedin/></Link>
                <Link to={initiator.facebook} target="_blank"><FaFacebook/></Link>
                <Link to={initiator.twitter} target="_blank"><FaTwitter/></Link>
              </div>
            </figcaption>
          </figure>
        ))}
