  ...
  return (
    <section className='home-hero'>
      <div className='w-5/6 px-3 md:px-20 lg:w-1/2 animate__animated animate__lightSpeedInLeft animate__slow'>
        <h2 className='text-center my-5 lg:text-left lg:w-96'>Lorem ipsum dolor sit amet.</h2>
        <h4 className='text-center my-5 lg:text-left lg:w-96'>Lorem ipsum dolor sit amet consectetur adipisicing elit, nostrum accusamus possimus illo quos earum?</h4>
